window.addEventListener("DOMContentLoaded", function () {
    ...
    function startEngineLoad() {
        ...
        try {
            ...
            // 🌟 THE UNSTOPPABLE FIX: Game Force Start Logic 🌟
            ...
            // Normal Wait Condition (Cars + Roads ONLY, No Sounds dependency)
            ...
            // FALLBACK TIMEOUT: Kisi bhi haalat mein 10 second baad menu khol dega!
            setTimeout(() => {
                clearInterval(checkInt);
                finishLoadingProcess();
            }, 10000);
    ...
    const createScene = function () {
        ...
        // ======================================================================
        // 🎵 NON-BLOCKING SOUND SYSTEM (Game loading ko kabhi nahi rokega)
        // ======================================================================
        // Null lagaya hai "checkAssetsLoaded" ki jagah, taaki yeh background me load ho, loading ko na roke!
        sfxCount = new BABYLON.Sound("countSfx", "assets/sound/count.mp3", s, null, { spatialSound: false, volume: 1.0 });
        sfxCar = new BABYLON.Sound("carSfx", "assets/sound/car.mp3", s, null, { loop: true, autoplay: false, spatialSound: false, volume: 0.8 });
        sfxCoin = new BABYLON.Sound("coinSfx", "assets/sound/coin.mp3", s, null, { spatialSound: false, volume: 1.0 });
        sfxCrash = new BABYLON.Sound("crashSfx", "https://playground.babylonjs.com/sounds/explosion.wav", s, null, { spatialSound: false, volume: 1.0 });
