window.addEventListener("DOMContentLoaded", function () {
    // ======================================================================
    // 🔊 AGGRESSIVE AUDIO UNLOCKER (100% Vercel & Mobile Browser Bypass)
    // ======================================================================
    ...
    // Har ek click aur touch par audio zinda rahega
    ...
    const createScene = function () {
        ...
        // ======================================================================
        // 🎵 VERCEL SOUND FIX (Relative Paths + HTML5 Streaming) 🎵
        // ======================================================================
        // HTML5: true forces the browser to stream the audio directly, preventing decoding errors.
        // Paths are now strictly relative ("assets/sound/...") so Vercel can find them easily.
        ...
        // Remote sounds work perfectly everywhere
