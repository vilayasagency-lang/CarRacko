window.addEventListener("DOMContentLoaded", function () {
    ...
    let gameData = {
        ...
        unlockedCars: JSON.parse(localStorage.getItem("ts_unlockedCars")) || [0, 1], // Default 0 and 1 unlocked
    ...
    const createScene = function () {
        ...
        // ======================================================================
        // 🎵 PERFECT SOUND SYSTEM (Spatial = false to guarantee full volume everywhere)
        // ======================================================================
        ...
        // Crash sound remotely from Babylon.js Playground server
    ...
    function gameOver() {
        ...
        // 🎵 CRASH EXPLOSION & STOP CAR SOUND 🎵
        if(sfxCar) sfxCar.pause();
