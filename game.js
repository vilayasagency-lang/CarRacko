window.addEventListener("DOMContentLoaded", function () {
    ...
    // ======================================================================
    // 🎵 HTML5 DIRECT AUDIO BYPASS (Vercel / HopWeb 100% Fix)
    // ======================================================================
    ...
    function createHTML5Sound(src, loop, volume) {
        ...
        audio.loop = loop;
        audio.volume = volume;
        audio.crossOrigin = "anonymous"; // Prevents CORS blocks on Vercel
        return {
            play: function() { 
            ...
            isReady: function() { return true; } // Fake isReady for compatibility
        };
    }

    // Force HTML5 Audio elements into browser cache
    ...
    bindBtn("startBtn", "click", () => {
        ...
        gameState = "COUNTDOWN";
        if (sfxCar) { sfxCar.stop(); sfxCar.setVolume(0.8); }
        if (carAudioDuckTimer) clearTimeout(carAudioDuckTimer);
        ...
        countdownInterval = setInterval(() => {
            ...
            if (count > 0) {
                ...
                // 👉 Guaranteed Car Engine Sound Start
